...
define(["require", "exports", "simulation.simulation", "jquery", "util", "interpreter.constants", "blockly", "simulation.types"], function (require, exports, simulation_simulation_1, $, UTIL, C, Blockly) {
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SelectionListener = exports.RobotFactory = exports.BaseRobot = void 0;
    var BaseRobot = /** @class */ (function () {
        function BaseRobot(id, configuration, interpreter, name, mySelectionListener) {
            this.debug = false;
        ...
        Object.defineProperty(BaseRobot.prototype, "interpreter", {
            get: function () {
        ...
        Object.defineProperty(BaseRobot.prototype, "name", {
            get: function () {
                return this._name;
            },
            set: function (value) {
        ...
        Object.defineProperty(BaseRobot.prototype, "id", {
            get: function () {
                return this._id;
            },
            set: function (value) {
        ...
        Object.defineProperty(BaseRobot.prototype, "configuration", {
            get: function () {
        ...
        Object.defineProperty(BaseRobot.prototype, "mobile", {
            get: function () {
                return this._mobile;
            },
            set: function (value) {
        ...
        Object.defineProperty(BaseRobot.prototype, "time", {
            get: function () {
                return this._time;
            },
            set: function (value) {
        ...
        Object.defineProperty(BaseRobot.prototype, "selected", {
            get: function () {
        ...
        BaseRobot.prototype.destroy = function () {
            this.removeMouseEvents();
            this.selected = false;
            this.mySelectionListener.remove(this.remover);
        };
        BaseRobot.prototype.draw = function (rCtx, dt) {
            var _this = this;
        ...
        BaseRobot.prototype.getLabel = function () {
            throw new Error('Method not implemented.');
        };
        BaseRobot.prototype.replaceState = function (interpreter) {
            this.interpreter = interpreter;
        };
        BaseRobot.prototype.reset = function () {
        ...
        BaseRobot.prototype.updateActions = function (myRobot, dt, interpreterRunning) {
        ...
        BaseRobot.prototype.updateSensors = function (running, dt, uCtx, udCtx, personalObstacleList) {
        ...
        BaseRobot.prototype.extendMouseEvent = function (e) {
            var X = e.clientX || e.originalEvent.touches[0].pageX;
            var Y = e.clientY || e.originalEvent.touches[0].pageY;
            var top = $('#robotLayer').offset().top;
            var left = $('#robotLayer').offset().left;
            var scale = simulation_simulation_1.Simulation.Instance.scale;
            e.startX = (X - left) / scale;
            e.startY = (Y - top) / scale;
        };
        BaseRobot.prototype.removeMouseEvents = function () {
            $('#robotLayer').off('.R' + this.id);
        };
        BaseRobot.prototype.addMouseEvents = function () {
        ...
        BaseRobot.prototype.drawLabel = function (dt) {
            var _this = this;
    ...
    var RobotFactory = /** @class */ (function () {
        ...
        RobotFactory.createRobots = function (interpreters, configurations, names, myListener, robotType) {
            return __awaiter(this, void 0, void 0, function () {
                var myRobotClass, myRobots;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            $('#simRobotContent').html('');
                            return [4 /*yield*/, new Promise(function (resolve_1, reject_1) { require(['EV3Robot'], resolve_1, reject_1); })];
                        case 1:
