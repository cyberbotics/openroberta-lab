define(["require", "exports", "./interpreter.state", "./interpreter.constants", "./interpreter.util", "neuralnetwork.ui", "simulation.simulation"], function (require, exports, interpreter_state_1, C, U, UI, simulation_simulation_1) {
    ...
    var Interpreter = /** @class */ (function () {
        ...
        Interpreter.prototype.stepOver = function (op) {
            simulation_simulation_1.Simulation.Instance.setPause(true);
            this.events[C.DEBUG_STEP_OVER] = false;
            this.stepOverBlock = null;
