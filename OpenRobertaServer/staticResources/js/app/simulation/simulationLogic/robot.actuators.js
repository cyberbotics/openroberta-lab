...
define(["require", "exports", "interpreter.constants", "simulation.math", "guiState.controller", "./simulation.objects", "util", "jquery", "blockly"], function (require, exports, C, SIMATH, GUISTATE_C, simulation_objects_1, UTIL, $, Blockly) {
    ...
    exports.WebAudio = exports.TTS = exports.Led = exports.EV3Chassis = exports.ChassisDiffDrive = void 0;
    ...
    var EV3Chassis = /** @class */ (function (_super) {
        ...
        function EV3Chassis(id, configuration, pose) {
            ...
            $('#brick' + _this.id).hide();
            var chassis = _this;
            for (var property in _this.buttons) {
                var $property = $('#' + property + _this.id);
        ...
        EV3Chassis.prototype.getLabel = function () {
            return ('<div><label>' +
                this.left.port +
                ' ' +
        ...
        EV3Chassis.prototype.reset = function () {
            this.encoder.left = 0;
        ...
        EV3Chassis.prototype.updateSensor = function (running, dt, myRobot, values, uCtx, udCtx, personalObstacleList) {
        ...
        EV3Chassis.prototype.updateButtons = function (running, values) {
            values.buttons = {};
        ...
        EV3Chassis.prototype.updateEncoders = function (running, values) {
            if (running) {
                values.encoder = {};
    ...
    var Led = /** @class */ (function () {
        ...
        Led.prototype.draw = function (rCtx, myRobot) {
            rCtx.save();
        ...
        Led.prototype.updateAction = function (myRobot, dt, interpreterRunning) {
