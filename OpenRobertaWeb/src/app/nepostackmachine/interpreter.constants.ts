...
export const MAX_SIM_ROBOTS: number = 10;
...
export const NN_STEP_STMT: string = 'nnStepStmt';
export const NN_CHANGEWEIGHT_STMT: string = 'nnChangeWeightStmt';
export const NN_CHANGEBIAS_STMT: string = 'nnChangeBiasStmt';
export const NN_GETOUTPUTNEURON_VAL: string = 'nnGetOutputNeuronVal';
...
export const DEFAULT_TRAIL_WIDTH = 15;
export const DEFAULT_TRAIL_COLOR = '#000';
export const MIN_SIZE_OBJECT = 10;
